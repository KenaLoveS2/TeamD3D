...
HRESULT CLevel_MapTool::Ready_Layer_Camera(const _tchar* pLayerTag)
{
	...
	auto pCamera = (CCamera*)pGameInstance->Clone_GameObject(
		TEXT("Prototype_GameObject_Camera_Dynamic"), nullptr, &CameraDesc);
	...
	pCamera = (CCamera*)pGameInstance->Clone_GameObject(
		TEXT("Prototype_GameObject_Camera_Dynamic"), nullptr, &CameraDesc);
	if (pCamera == nullptr) return E_FAIL;
...
HRESULT CLevel_MapTool::Ready_Layer_Effect(const _tchar* pLayerTag)
{
	...
	if (FAILED(pGameInstance->Clone_GameObject(g_LEVEL, pLayerTag, TEXT("Prototype_GameObject_WorldTrigger"), L"UIWorldTrigger", nullptr)))
		return E_FAIL;

	//if (FAILED(pGameInstance->Clone_GameObject(g_LEVEL, pLayerTag, TEXT("Prototype_GameObject_ExplosionGravity"), L"Test", nullptr, &pGameObject)))
	//	return E_FAIL;

	//if (FAILED(pGameInstance->Clone_GameObject(g_LEVEL, pLayerTag, TEXT("Prototype_GameObject_Swipes_Charged"), L"Swipes_Charged", nullptr, &pGameObject)))
	//	return E_FAIL;

	//if (FAILED(pGameInstance->Clone_GameObject(g_LEVEL, pLayerTag, TEXT("Prototype_GameObject_Warrior_FireSwipe"), L"Swipe", nullptr, &pGameObject)))
	//	return E_FAIL;
...
{
	auto pInstance = new CLevel_MapTool(pDevice, pContext);
