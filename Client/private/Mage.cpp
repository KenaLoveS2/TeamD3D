...
HRESULT CMage::SetUp_Components()
{
	...
	FAILED_CHECK_RETURN(__super::Add_Component(g_LEVEL_FOR_COMPONENT, L"Prototype_Component_Model_Mage", L"Com_Model", (CComponent**)&m_pModelCom, nullptr, this), E_FAIL);
