...
HRESULT CKena_MainOutfit::SetUp_Components()
{
	...
	FAILED_CHECK_RETURN(__super::Add_Component(g_LEVEL_FOR_COMPONENT, L"Prototype_Component_Model_Kena_MainOutfit", L"Com_Model", (CComponent**)&m_pModelCom, nullptr, this), E_FAIL);
	...
	for(_uint i = 3; i<5; ++i)
	{
		...
		// Alpha
		m_pModelCom->SetUp_Material(i, WJTextureType_ALPHA, TEXT("../Bin/Resources/Anim/Kena/hair_ALPHA.png"));
		// Root
