...
void CWorldTrigger_S2::Imgui_RenderProperty()
{
	...
	/* Type */
	ImGui::DragInt("Type(Quest,Alarm,Line)", (_int*)&m_tDesc.eType, 1.f, 0, TYPE_END);
...
HRESULT CWorldTrigger_S2::SetUp_Components()
{
	...
	if (FAILED(__super::Add_Component(g_LEVEL, TEXT("Prototype_Component_Collider_AABB_ForTrigger"), TEXT("Com_AABB"),
