...
HRESULT CKena_State::Initialize(CKena * pKena, CKena_Status * pStatus, CStateMachine * pStateMachine, CModel * pModel, CAnimationState * pAnimation, CTransform * pTransform, CCamera_Player * pCamera)
{
	...
	FAILED_CHECK_RETURN(SetUp_State_Grab(), E_FAIL);
...
HRESULT CKena_State::SetUp_State_Aim()
{
	m_pStateMachine->Add_State(L"AIM_INTO")
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"ROT_ACTION_AIM", this, &CKena_State::RotAction, &CKena_State::KeyDown_R)
		.Init_Changer(L"TELEPORT_FLOWER", this, &CKena_State::Teleport_Flower)
		.Init_Changer(L"TAKE_DAMAGE", this, &CKena_State::CommonHit)
		.Init_Changer(L"ROLL", this, &CKena_State::KeyDown_LCtrl, &CKena_State::KeyInput_Direction)
		.Init_Changer(L"BACKFLIP", this, &CKena_State::KeyDown_LCtrl, &CKena_State::KeyInput_None)
		.Init_Changer(L"JUMP_SQUAT", this, &CKena_State::KeyDown_Space)
		.Init_Changer(L"BOW_CHARGE", this, &CKena_State::MouseInput_Left, &CKena_State::Check_ArrowCount, &CKena_State::Check_Skill_Bow_0)
		.Init_Changer(L"BOMB_INTO", this, &CKena_State::MouseInput_Right, &CKena_State::Check_BombCount, &CKena_State::Check_Skill_Bomb_0)
		...
		.Init_Changer(L"BOW_CHARGE_RUN", this, &CKena_State::MouseInput_Left, &CKena_State::Check_ArrowCount, &CKena_State::Check_Skill_Bow_0)
		.Init_Changer(L"BOMB_INTO_RUN", this, &CKena_State::MouseInput_Right, &CKena_State::Check_BombCount, &CKena_State::Check_Skill_Bomb_0)
...
HRESULT CKena_State::SetUp_State_Aim_Air()
{
	m_pStateMachine->Add_State(L"AIM_AIR_INTO")
		...
		.Init_Changer(L"BOW_AIR_CHARGE", this, &CKena_State::MouseInput_Left, &CKena_State::Check_ArrowCount, &CKena_State::Check_Skill_Bow_0)
		.Init_Changer(L"BOMB_AIR_INTO", this, &CKena_State::MouseInput_Right, &CKena_State::Check_BombCount, &CKena_State::Check_Skill_Bomb_0)
...
HRESULT CKena_State::SetUp_State_Attack1()
{
	m_pStateMachine->Add_State(L"ATTACK_1")
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"ROT_ACTION", this, &CKena_State::RotAction, &CKena_State::KeyDown_R, NULLFUNC, &CKena_State::Animation_Progress, 0.29f)
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"ROT_ACTION", this, &CKena_State::RotAction, &CKena_State::KeyDown_R, NULLFUNC, &CKena_State::Animation_Progress, 0.27f)
...
HRESULT CKena_State::SetUp_State_Attack2()
{
	m_pStateMachine->Add_State(L"ATTACK_2")
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"ROT_ACTION", this, &CKena_State::RotAction, &CKena_State::KeyDown_R, NULLFUNC, &CKena_State::Animation_Progress, 0.25f)
...
HRESULT CKena_State::SetUp_State_Attack3()
{
	m_pStateMachine->Add_State(L"ATTACK_3")
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"ROT_ACTION", this, &CKena_State::RotAction, &CKena_State::KeyDown_R, NULLFUNC, &CKena_State::Animation_Progress, 0.14f)
...
HRESULT CKena_State::SetUp_State_Attack4()
{
	m_pStateMachine->Add_State(L"ATTACK_4")
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"ROT_ACTION", this, &CKena_State::RotAction, &CKena_State::KeyDown_R, NULLFUNC, &CKena_State::Animation_Progress, 0.38f)
...
HRESULT CKena_State::SetUp_State_Bomb()
{
	m_pStateMachine->Add_State(L"BOMB_INTO")
		...
		.Init_Changer(L"BACKFLIP", this, &CKena_State::KeyDown_LCtrl, &CKena_State::KeyInput_None)
		.Init_Changer(L"JUMP_SQUAT", this, &CKena_State::KeyDown_Space)
		.Init_Changer(L"BOMB_INJECT", this, &CKena_State::KeyDown_R, &CKena_State::Check_PipCount, &CKena_State::Check_Skill_Rot_4)
		...
		.Init_Changer(L"ROLL", this, &CKena_State::KeyDown_LCtrl, &CKena_State::KeyInput_Direction)
		.Init_Changer(L"RUNNING_JUMP_SQUAT", this, &CKena_State::KeyDown_Space)
		.Init_Changer(L"BOMB_INJECT_RUN", this, &CKena_State::KeyDown_R, &CKena_State::Check_PipCount, &CKena_State::Check_Skill_Rot_4)
...
HRESULT CKena_State::SetUp_State_Bow()
{
	m_pStateMachine->Add_State(L"BOW_CHARGE")
		...
		.Init_Changer(L"BACKFLIP", this, &CKena_State::KeyDown_LCtrl, &CKena_State::KeyInput_None)
		.Init_Changer(L"JUMP_SQUAT", this, &CKena_State::KeyDown_Space)
		.Init_Changer(L"BOW_INJECT", this, &CKena_State::Check_PipCount, &CKena_State::KeyDown_R, &CKena_State::Check_Skill_Rot_3)
		...
		.Init_Changer(L"TELEPORT_FLOWER", this, &CKena_State::Teleport_Flower)
		.Init_Changer(L"AIM_RETURN", this, &CKena_State::KeyUp_LShift)
		.Init_Changer(L"BOW_INJECT_WALK", this, &CKena_State::Check_PipCount, &CKena_State::KeyDown_R, &CKena_State::Check_Skill_Rot_3)
...
HRESULT CKena_State::SetUp_State_Death()
{
	m_pStateMachine->Add_State(L"DEATH")
		.Init_Changer(L"DEATH_FRONT", this, &CKena_State::Damaged_Dir_Front)
		.Init_Changer(L"DEATH_BACK", this, &CKena_State::Damaged_Dir_Back)
		.Init_Changer(L"DEATH_WATER", this, &CKena_State::Death_Water)

		.Add_State(L"DEATH_FRONT")
		...
		.Init_Changer(L"RESPAWN", this, &CKena_State::Animation_Finish, &CKena_State::Respawn_Ready)
...
HRESULT CKena_State::SetUp_State_Pulse()
{
	m_pStateMachine->Add_State(L"INTO_PULSE")
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"SPIN_ATTACK", this, &CKena_State::MouseDown_Left, &CKena_State::Check_Skill_Shield_1, NULLFUNC, &CKena_State::Animation_Progress, 0.35f)
		.Init_Changer(L"IDLE", this, &CKena_State::Animation_Finish)
...
HRESULT CKena_State::SetUp_State_Sprint()
{
	m_pStateMachine->Add_State(L"INTO_SPRINT")
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"ROT_ACTION", this, &CKena_State::RotAction, &CKena_State::KeyDown_R, NULLFUNC, &CKena_State::Animation_Progress, 0.26f)
...
HRESULT CKena_State::SetUp_State_Dodge()
{
	m_pStateMachine->Add_State(L"BACKFLIP")
		...
		.Init_Changer(L"ROT_ACTION", this, &CKena_State::RotAction, &CKena_State::KeyDown_R, NULLFUNC, &CKena_State::Animation_Progress, 0.42f)
...
HRESULT CKena_State::SetUp_State_Fall()
{
	m_pStateMachine->Add_State(L"FALL")
		...
		.Init_Changer(L"AIR_ATTACK_1", this, &CKena_State::MouseDown_Left)
		.Init_Changer(L"AIR_ATTACK_SLAM_INTO", this, &CKena_State::MouseDown_Right, &CKena_State::Check_Skill_Melee_3)
...
HRESULT CKena_State::SetUp_State_Grab()
{
	m_pStateMachine->Add_State(L"WARRIOR_GRAB")
		.Init_Start(this, &CKena_State::Start_Warrior_Grab)
		.Init_Tick(this, &CKena_State::Tick_Warrior_Grab)
		.Init_End(this, &CKena_State::End_Warrior_Grab)
		.Init_Changer(L"LOCK_ON_IDLE", this, &CKena_State::Animation_Finish)
...
HRESULT CKena_State::SetUp_State_Heavy_Attack1()
{
	m_pStateMachine->Add_State(L"HEAVY_ATTACK_1_CHARGE")
		...
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"JUMP_SQUAT", this, &CKena_State::KeyDown_Space, NULLFUNC, NULLFUNC, &CKena_State::Animation_Progress, 0.25f)
		.Init_Changer(L"HEAVY_ATTACK_1_RELEASE_PERFECT", this, &CKena_State::MouseUp_Right, &CKena_State::HeavyAttack1_Perfect, &CKena_State::Check_Skill_Melee_4)
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"ROT_ACTION", this, &CKena_State::RotAction, &CKena_State::KeyDown_R, NULLFUNC, &CKena_State::Animation_Progress, 0.21f)
...
HRESULT CKena_State::SetUp_State_Heavy_Attack2()
{
	m_pStateMachine->Add_State(L"HEAVY_ATTACK_2_CHARGE")
		...
		.Init_Changer(L"HEAVY_ATTACK_2_RELEASE_PERFECT", this, &CKena_State::MouseUp_Right, &CKena_State::HeavyAttack2_Perfect, &CKena_State::Check_Skill_Melee_4)
...
HRESULT CKena_State::SetUp_State_Heavy_Attack3()
{
	m_pStateMachine->Add_State(L"HEAVY_ATTACK_3_CHARGE")
		...
		.Init_Changer(L"HEAVY_ATTACK_3_RELEASE_PERFECT", this, &CKena_State::MouseUp_Right, &CKena_State::HeavyAttack3_Perfect, &CKena_State::Check_Skill_Melee_4)
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"ROT_ACTION", this, &CKena_State::RotAction, &CKena_State::KeyDown_R, NULLFUNC, &CKena_State::Animation_Progress, 0.24f)
...
HRESULT CKena_State::SetUp_State_Heavy_Attack_Combo()
{
	m_pStateMachine->Add_State(L"HEAVY_ATTACK_COMBO")
		...
		.Init_Changer(L"DEATH", this, &CKena_State::Death)
		.Init_Changer(L"WARRIOR_GRAB", this, &CKena_State::Grab_Warrior)
		.Init_Changer(L"ROT_ACTION", this, &CKena_State::RotAction, &CKena_State::KeyDown_R, NULLFUNC, &CKena_State::Animation_Progress, 0.55f)
...
void CKena_State::Start_Warrior_Grab(_float fTimeDelta)
{
	m_pAnimationState->State_Animation("WARRIOR_GRAB");
...
void CKena_State::Start_Pulse_Parry(_float fTimeDelta)
{
	...
	if (m_pStatus->Get_SkillState(CKena_Status::SKILL_SHIELD, 3))
...
void CKena_State::Tick_Warrior_Grab(_float fTimeDelta)
{
	...
	CBossWarrior* pWarrior = dynamic_cast<CBossWarrior*>(m_pKena->m_pAttackObject);
	if (pWarrior == nullptr)
		return;

	CModel* pWarriorModel = dynamic_cast<CModel*>(pWarrior->Find_Component(L"Com_Model"));

	if (pWarriorModel->Get_AnimIndex() == 14)
	{
		CBone* pGrabJnt = pWarrior->Get_GrabJointBonePtr();
		_matrix	matGrabJnt = pGrabJnt->Get_CombindMatrix() * pWarriorModel->Get_PivotMatrix() * pWarrior->Get_TransformCom()->Get_WorldMatrix();
		_float4	vWarriorPos = pWarrior->Get_TransformCom()->Get_Position();
		_float4	vGrabPos = matGrabJnt.r[3];
		...
		if (vGrabPos != vWarriorPos)
		{
			...
			m_pTransform->LookAt_NoUpDown(vWarriorPos);
		}
	}
}
...
void CKena_State::End_Warrior_Grab(_float fTimeDelta)
{
	m_pKena->m_bGrabWarrior = false;
	m_pKena->m_pAttackObject = nullptr;
}
...
_bool CKena_State::Death()
{
	return m_pKena->m_bDeath;
}

_bool CKena_State::Death_Water()
{
	return m_pKena->m_bDeath && m_pKena->m_bWater;
}

_bool CKena_State::Respawn_Ready()
{
	return true;
}

_bool CKena_State::Grab_Warrior()
{
	return m_pKena->m_bGrabWarrior && m_pKena->m_pAttackObject && dynamic_cast<CBossWarrior*>(m_pKena->m_pAttackObject);
}

_bool CKena_State::CommonHit()
{
	return m_pKena->m_bCommonHit && !m_pKena->m_bHeavyHit && !m_pKena->m_bPulse && !m_pKena->m_bDeath;
}
...
_bool CKena_State::RotAction()
{
	return m_pKena->m_bRotActionPossible;
}
...
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_MELEE, 0);
}

_bool CKena_State::Check_Skill_Melee_1()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_MELEE, 1);
}

_bool CKena_State::Check_Skill_Melee_2()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_MELEE, 2);
}

_bool CKena_State::Check_Skill_Melee_3()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_MELEE, 3);
}

_bool CKena_State::Check_Skill_Melee_4()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_MELEE, 4);
}

_bool CKena_State::Check_Skill_Shield_0()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_SHIELD, 0);
}

_bool CKena_State::Check_Skill_Shield_1()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_SHIELD, 1);
}

_bool CKena_State::Check_Skill_Shield_2()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_SHIELD, 2);
}

_bool CKena_State::Check_Skill_Shield_3()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_SHIELD, 3);
}

_bool CKena_State::Check_Skill_Shield_4()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_SHIELD, 4);
}

_bool CKena_State::Check_Skill_Bow_0()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_BOW, 0);
}

_bool CKena_State::Check_Skill_Bow_1()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_BOW, 1);
}

_bool CKena_State::Check_Skill_Bow_2()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_BOW, 2);
}

_bool CKena_State::Check_Skill_Bow_3()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_BOW, 3);
}

_bool CKena_State::Check_Skill_Bow_4()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_BOW, 4);
}

_bool CKena_State::Check_Skill_Bomb_0()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_BOMB, 0);
}

_bool CKena_State::Check_Skill_Bomb_1()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_BOMB, 1);
}

_bool CKena_State::Check_Skill_Bomb_2()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_BOMB, 2);
}

_bool CKena_State::Check_Skill_Bomb_3()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_BOMB, 3);
}

_bool CKena_State::Check_Skill_Bomb_4()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_BOMB, 4);
}

_bool CKena_State::Check_Skill_Rot_0()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_ROT, 0);
}

_bool CKena_State::Check_Skill_Rot_1()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_ROT, 1);
}

_bool CKena_State::Check_Skill_Rot_2()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_ROT, 2);
}

_bool CKena_State::Check_Skill_Rot_3()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_ROT, 3);
}

_bool CKena_State::Check_Skill_Rot_4()
{
	return m_pStatus->Get_SkillState(CKena_Status::SKILL_ROT, 4);
}
...
_bool CKena_State::Damaged_Dir_False()
{
	return m_pKena->m_eDamagedDir == CKena::DAMAGED_FROM_END;
}
...
_bool CKena_State::Check_BombCount()
{
	return m_pKena->m_pCurBomb == nullptr && m_pStatus->Get_CurBombCount() > 0;
}
