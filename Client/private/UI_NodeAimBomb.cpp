#include "stdafx.h"
#include "..\public\UI_NodeAimBomb.h"
#include "GameInstance.h"


CUI_NodeAimBomb::CUI_NodeAimBomb(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	:CUI_Node(pDevice, pContext)
{
}

CUI_NodeAimBomb::CUI_NodeAimBomb(const CUI_NodeAimBomb & rhs)
	: CUI_Node(rhs)
{
}

HRESULT CUI_NodeAimBomb::Initialize_Prototype()
{
...
HRESULT CUI_NodeAimBomb::Initialize(void * pArg)
{
...
void CUI_NodeAimBomb::Tick(_float fTimeDelta)
{
...
void CUI_NodeAimBomb::Late_Tick(_float fTimeDelta)
{
	if (m_bStart)
	{
...
HRESULT CUI_NodeAimBomb::Render()
{
...
HRESULT CUI_NodeAimBomb::SetUp_Components()
{
	/* Renderer */
...
HRESULT CUI_NodeAimBomb::SetUp_ShaderResources()
{
...
CUI_NodeAimBomb * CUI_NodeAimBomb::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CUI_NodeAimBomb*	pInstance = new CUI_NodeAimBomb(pDevice, pContext);
	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed To Create : CUI_NodeAimBomb");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CUI_NodeAimBomb::Clone(void * pArg)
{
	CUI_NodeAimBomb*	pInstance = new CUI_NodeAimBomb(*this);
	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed To Clone : CUI_NodeAimBomb");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CUI_NodeAimBomb::Free()
{
	__super::Free();
}
