#include "stdafx.h"
#include "..\public\UI_NodeAimArrow.h"
#include "GameInstance.h"

CUI_NodeAimArrow::CUI_NodeAimArrow(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	:CUI_Node(pDevice, pContext)
{
}

CUI_NodeAimArrow::CUI_NodeAimArrow(const CUI_NodeAimArrow & rhs)
	: CUI_Node(rhs)
	, m_eState(STATE_FULL)
{
}

HRESULT CUI_NodeAimArrow::Initialize_Prototype()
{
...
HRESULT CUI_NodeAimArrow::Initialize(void * pArg)
{
...
HRESULT CUI_NodeAimArrow::Render()
{
...
HRESULT CUI_NodeAimArrow::SetUp_Components()
{
	/* Renderer */
...
HRESULT CUI_NodeAimArrow::SetUp_ShaderResources()
{
...
CUI_NodeAimArrow * CUI_NodeAimArrow::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CUI_NodeAimArrow*	pInstance = new CUI_NodeAimArrow(pDevice, pContext);
	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed To Create : CUI_NodeAimArrow");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CUI_NodeAimArrow::Clone(void * pArg)
{
	CUI_NodeAimArrow*	pInstance = new CUI_NodeAimArrow(*this);
	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed To Clone : CUI_NodeAimArrow");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CUI_NodeAimArrow::Free()
{
	__super::Free();
}
