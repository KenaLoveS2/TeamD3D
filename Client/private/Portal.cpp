...
HRESULT CPortal::Late_Initialize(void* pArg)
{
...
void CPortal::Imgui_RenderProperty()
{
	CGameObject::Imgui_RenderProperty();
}

void CPortal::ImGui_ShaderValueProperty()
{
	CGameObject::ImGui_ShaderValueProperty();
}

void CPortal::ImGui_PhysXValueProperty()
{
...
HRESULT CPortal::SetUp_Components()
{
	...
	for (_uint i = 0; i < iNumMeshes; ++i)
	{
		m_pModelCom->SetUp_Material(i, WJTextureType_DIFFUSE, L"../Bin/Resources/Textures/Test.png");
	}
	return S_OK;
}
...
CGameObject* CPortal::Clone(void* pArg)
{
	...
	{
		MSG_BOX("Failed to Clone : CPortal");
		Safe_Release(pInstance);
	}
