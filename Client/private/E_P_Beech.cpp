#include "stdafx.h"
#include "..\public\E_P_Beech.h"
#include "GameInstance.h"

CE_P_Beech::CE_P_Beech(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CEnviromentObj(pDevice, pContext)
{
}

CE_P_Beech::CE_P_Beech(const CE_P_Beech & rhs)
	: CEnviromentObj(rhs)
{
}

HRESULT CE_P_Beech::Initialize_Prototype(const _tchar * pFilePath)
{
...
HRESULT CE_P_Beech::Initialize(void * pArg)
{
...
HRESULT CE_P_Beech::Late_Initialize(void* pArg)
{
...
void CE_P_Beech::Tick(_float fTimeDelta)
{
...
void CE_P_Beech::Late_Tick(_float fTimeDelta)
{
...
HRESULT CE_P_Beech::SetUp_Components()
{
	...
	/* For.Com_Model */ 	
	FAILED_CHECK_RETURN(__super::Add_Component(g_LEVEL_FOR_COMPONENT, L"Prototype_Component_Model_Beech", TEXT("Com_Model"),
...
HRESULT CE_P_Beech::SetUp_ShaderResources()
{
...
CE_P_Beech * CE_P_Beech::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, const _tchar * pFilePath)
{
	CE_P_Beech * pInstance = new CE_P_Beech(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype(pFilePath)))
	{
		MSG_BOX("CE_P_Beech Create Failed");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CE_P_Beech::Clone(void * pArg)
{
	CE_P_Beech * pInstance = new CE_P_Beech(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("CE_P_Beech Clone Failed");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CE_P_Beech::Free()
{
	__super::Free();
