#include "stdafx.h"
#include "..\public\BombGimmickObj.h"
#include "GameInstance.h"
#include "ControlMove.h"
#include "Interaction_Com.h"

CBombGimmickObj::CBombGimmickObj(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:CEnviromentObj(pDevice, pContext)
{
}

CBombGimmickObj::CBombGimmickObj(const CBombGimmickObj& rhs)
	: CEnviromentObj(rhs)
{
}

HRESULT CBombGimmickObj::Initialize_Prototype()
{
...
HRESULT CBombGimmickObj::Initialize(void* pArg)
{
...
HRESULT CBombGimmickObj::Late_Initialize(void* pArg)
{
...
void CBombGimmickObj::Tick(_float fTimeDelta)
{
...
void CBombGimmickObj::Late_Tick(_float fTimeDelta)
{
...
HRESULT CBombGimmickObj::Render()
{
...
HRESULT CBombGimmickObj::RenderShadow()
{
...
HRESULT CBombGimmickObj::Add_AdditionalComponent(_uint iLevelIndex, const _tchar* pComTag, COMPONENTS_OPTION eComponentOption)
{
...
HRESULT CBombGimmickObj::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CBombGimmickObj::SetUp_ShaderResources()
{
...
HRESULT CBombGimmickObj::SetUp_ShadowShaderResources()
{
	NULL_CHECK_RETURN(m_pShaderCom, E_FAIL);
	FAILED_CHECK_RETURN(m_pTransformCom->Bind_ShaderResource(m_pShaderCom, "g_WorldMatrix"), E_FAIL);
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
CBombGimmickObj* CBombGimmickObj::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CBombGimmickObj* pInstance = new CBombGimmickObj(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CBombGimmickObj");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CBombGimmickObj::Clone(void* pArg)
{
	CBombGimmickObj* pInstance = new CBombGimmickObj(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CBombGimmickObj");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CBombGimmickObj::Free()
{
	__super::Free();
