...
HRESULT CLevel_GamePlay::Ready_Layer_Environment(const _tchar * pLayerTag)
{
	...
	CImgui_MapEditor::Load_MapObjects(LEVEL_GAMEPLAY, "Test_GimmickUp.json");
...
HRESULT CLevel_GamePlay::Ready_Layer_Monster(const _tchar * pLayerTag)
{
	...
	if (FAILED(pGameInstance->Clone_AnimObject(LEVEL_GAMEPLAY, pLayerTag, TEXT("Prototype_GameObject_RockGolem"), L"Rock", nullptr, &pGameObject))) return E_FAIL;
...
HRESULT CLevel_GamePlay::Ready_Layer_Effect(const _tchar * pLayerTag)
{
	...
	if (FAILED(pGameInstance->Clone_GameObject(LEVEL_GAMEPLAY, pLayerTag, TEXT("Prototype_GameObject_EffectFlower"), L"flower")))
		return E_FAIL;
...
HRESULT CLevel_GamePlay::Ready_Layer_ControlRoom(const _tchar* pLayerTag)
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
	pGameInstance->Clone_GameObject(LEVEL_GAMEPLAY, pLayerTag, TEXT("Prototype_GameObject_ControlRoom"), L"ControlRoom");
	RELEASE_INSTANCE(CGameInstance);
	return S_OK;
}
