...
namespace Client
{
	...
	enum COLLIDER_INDEX {
		...
		COL_PULSE, COL_GIMMICK_TREE, COL_TELEPORT_FLOWER, COL_CHEST, COL_HEALTHFLOWER, COL_PORTAL, COL_BOWTARGET,
		COL_DYNAMIC_ENVIOBJ,
		COLLIDER_INDEX_END,
	};
	...
	enum TRIGGER_INDEX {
		...
		TRIGGER_PULSE_PLATE,
		TRIGGER_PULSE,
		TRIGGER_TELEPORT_FLOWER, TRIGGER_CHEST,	TRIGGER_HEALTHFLOWER,
		TRIGGER_END
	};
}
