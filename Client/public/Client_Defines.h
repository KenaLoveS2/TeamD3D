...
namespace Client
{
	...
	enum SOUND { SOUND_BGM, SOUND_UI, SOUND_PLAYER_VOICE, SOUND_PLAYER_SFX, SOUND_NPC, SOUND_RAIN, SOUND_MONSTER = 11, SOUND_END = 12 };
	...
	enum COLLIDER_INDEX {
		...
		COL_MONSTER, COL_MONSTER_WEAPON, COL_MONSTER_ARROW, COL_WARRIOR_GRAB_HAND, COL_BOSS_SWIPECHARGE, COL_SHAMAN_HEX,
