...
public:
	enum CAMOFFSET {
		CAMOFFSET_DEFAULT, CAMOFFSET_BOSSBATTLE, CAMOFFSET_GRAB_WARRIOR, CAMOFFSET_MASK, CAMOFFSET_AIM, CAMOFFSET_AIR_AIM, CAMOFFSET_INJECTBOW, CAMOFFSET_PULSE, CAMOFFSET_PARRY, CAMOFFSET_HEAVYATTACK, CAMOFFSET_END
	};
