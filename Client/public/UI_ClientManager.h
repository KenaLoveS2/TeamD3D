...
public:
	enum UI_PRESENT {
		...
		AMMO_ARROW, AMMO_ARROWCOOL, AMMO_ARROWEFFECT, AMMO_ARROWRECHARGE,
		AMMO_BOMB, AMMO_BOMBCOOL, AMMO_BOMBEFFECT, AMMO_BOMBRECHARGE, AMMO_BOMBMOMENT,
	...
	enum UI_CANVAS { CANVAS_HUD, CANVAS_AMMO, CANVAS_AIM, CANVAS_QUEST, CANVAS_INV, CANVAS_UPGRADE, 
						CANVAS_BOTTOM, CANVAS_TOP,/* CANVAS_HATCARTBG,*/ /* CANVAS_HATCARTITEM, */
