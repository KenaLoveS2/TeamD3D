...
BEGIN(Client)
class CUI_CanvasInv final : public CUI_Canvas
{
public:
...
private:
	CUI_CanvasInv(ID3D11Device*	pDevice, ID3D11DeviceContext* pContext);
	CUI_CanvasInv(const CUI_CanvasInv& rhs);
	virtual ~CUI_CanvasInv() = default;
...
public:
	static	CUI_CanvasInv*	Create(ID3D11Device* pDevice, ID3D11DeviceContext*	pContext);
