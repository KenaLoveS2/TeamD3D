...
public:
	enum FIELD_STATE {
		FIELD_IDLE, FIELD_VILLAGE, FIELD_SHOP, FIELD_PUZZLE, FIELD_LEVELUP,
		FIELD_INTO_BATTLE, FIELD_FROM_BATTLE, FIELD_BATTLE,
		FIELD_BOSS_BATTLE_WARRIOR_PHASE_1, FIELD_BOSS_BATTLE_WARRIOR_PHASE_2, FIELD_BOSS_BATTLE_HUNTER, FIELD_BOSS_BATTLE_SHAMAN,
		FIELD_STATE_END };
