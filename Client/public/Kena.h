...
public:
	...
	enum STATERETURN { STATE_ATTACK, STATE_HEAVYATTACK, STATE_PERFECTATTACK, STATE_COMMONHIT, STATE_HEAVYHIT, STATE_SPRINT, STATE_AIM, STATE_BOW, STATE_INJECTBOW, STATE_PULSE, STATE_PARRY, STATE_JUMP, STATERETURN_END };
