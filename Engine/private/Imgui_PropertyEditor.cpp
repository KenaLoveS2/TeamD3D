...
{
	CObject_Manager::GetInstance()->Imgui_ObjectViewer(CLevel_Manager::GetInstance()->Get_CurrentLevelIndex(), m_pSelectedObject);
	...
	CObject_Manager::GetInstance()->Imgui_Swap_Render_Sorting(
		CLevel_Manager::GetInstance()->Get_CurrentLevelIndex(),
		m_pSelectedObject);
	*/
